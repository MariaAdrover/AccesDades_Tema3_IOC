...
@Entity
@NamedQueries({
    @NamedQuery(name = "Client.clientPerNif",
            query = "SELECT c FROM Client c WHERE c.nif=:nif"),
    @NamedQuery(name = "Client.clientsPerNom",
            query = "SELECT c FROM Client c WHERE c.nom like :nom"),
    @NamedQuery(name = "Client.clientsPerSector",
            query = "SELECT c FROM Client c WHERE c.sector.id=:sector")
})
